...
I have changed all List instances to Set because a Set does not contain duplicate elements, and it allows direct use of the contains method to check if a sentence already exists.
...
Because OSU CSE components hides all secondary abstract class, I'm not sure about what the class skeleton should be.
