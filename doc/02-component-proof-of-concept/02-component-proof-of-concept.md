...
This is my favorite design. Although this is definitely the hardest one, I still choose this one. I spent almost 70% time in the brainstrom part to design this.
...
I love this assignment, it makes me learn a lot. I'm still confused about the PoC. I don't know which part should be included in the file, and which are not needed. And when I was doing this assignment, I realized that the methods I designed in brainstrom part is far from enough. I still can't decide very well how to allocate my methods. I'm not sure which ones should be in the kernel and which should be in the secondary. Is there any rules I should follow?
